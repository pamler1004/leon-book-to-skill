...
Works with any host that supports the open [Agent Skills](https://github.com/agentskills/agentskills) standard. Codex is the recommended host; GitHub Copilot CLI, Amp, and Claude Code can also read the same `SKILL.md` format.
